const contractABI = [
  {
    inputs: [
      ...
      { internalType: "uint64", name: "suscriptionId", type: "uint64" },
      ...
      { internalType: "string[3]", name: "nftTokenUris", type: "string[3]" },
    ],
  ...
  { inputs: [], name: "RandomNFT_AllreadyInitialized", type: "error" },
  { inputs: [], name: "RandomNFT_NeedMoreFunds", type: "error" },
  { inputs: [], name: "RandomNFT_RangeOurOfBounds", type: "error" },
  { inputs: [], name: "RandomNFT_TransferFailed", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    inputs: [
      {
        indexed: false,
        internalType: "enum RandomNFT.Breed",
        name: "breed",
        type: "uint8",
      },
      {
  ...
  {
    inputs: [{ internalType: "uint256", name: "moddedRng", type: "uint256" }],
    name: "getBreedFromModdedRng",
    outputs: [
      { internalType: "enum RandomNFT.Breed", name: "", type: "uint8" },
    ],
